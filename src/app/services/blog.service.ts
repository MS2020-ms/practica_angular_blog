...
export class BlogService {
  ...
  constructor() {
    ...
    this.arrPosts = [
      ...
      {
        titulo: 'EMOP 2020',
        texto: 'European Month of Photography Berlin (EMOP) 1—31 OCT 2020. Es el mayor festival de fotografía en Alemania. Desde 2004, se lleva a cabo cada dos años en Berlín, presentando una amplia gama de exposiciones y eventos sobre fotografía histórica y contemporánea. El festival está organizado por Kulturprojekte Berlin GmbH en colaboración con museos, instituciones culturales y galerías.',
